...
<body class="top-navbar-fixed">
                                            ...
                                            <div class="table-container">
                                                ...
                                                <table class="table" editable=true id="data-table">
                                                    <thead>
                                                        ...
                                                        <th colName="class">Class</th>
                                                        <th colName="section">Subjects</th>
    ...
    <script>
        getTableDataArray(<?php echo json_encode($existingData["subjectcombs"]); ?>, true, <?php echo json_encode($existingData); ?>, "subjectcombs", true, false)
    </script>
</body>
</html>