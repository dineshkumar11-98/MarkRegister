...
<body class="top-navbar-fixed">
                                        ...
                                        <div class="panel-body p-20">
                                            <div class="table-container">
                                                ...
                                                <table class="table" editable=true id="data-table">
                                                    <thead>
                                                        <th colName="sno">S.No<span></span></th>
                                                        <th colName="schoolid">School Id<span></span></th>
                                                        <th colName="school">School<span></span></th>
                                                        <th colName="action">Action<span></span></th>
                                                    </thead>
                                                    <tbody></tbody>
                                                </table>
    ...
    <script>
        getTableDataArray(<?php echo json_encode($existingData["schools"]); ?>, true, <?php echo json_encode($existingData); ?>, "schools", true, [true, true])
        function onValueChange(oldValue, newValue, array_index, columnName) {
            if(columnName == 'schoolid') {
                fetch("saveUpdatedDataToAll.php", {
                    ...
                    body: JSON.stringify({"oldSch":oldValue, 'newSch':newValue, "colName": columnName})
                })
            }
        }
    </script>
