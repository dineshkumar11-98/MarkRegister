...
<body class="top-navbar-fixed">
                                        ...
                                        <div class="panel-body p-20">
                                            <div class="table-container">
                                                ...
                                                <table class="table" editable=true id="data-table">
                                                    <thead>
                                                        <th colName="sno" sortable="false">S.No</th>
                                                        <th colName="class" sortable="true">Class</th>
                                                        <th colName="section" sortable="true">Section</th>
                                                        <th colName="section" sortable="true">Action</th>
                                                    </thead>
                                                    <tbody></tbody>
                                                </table>
    ...
    <script>
        getTableDataArray(<?php echo json_encode($existingData["classes"]); ?>, true, <?php echo json_encode($existingData); ?>, "classes", true, [false, false])
        function onValueChange(oldValue, newValue, array_index, column) {
            ...
            fetch("saveUpdatedDataToAll.php", {
                ...
                body: JSON.stringify({"oldClass":oldValue, 'newClass':newValue, "array_index": array_index, "column":column})
            })
        }
    </script>
</body>
