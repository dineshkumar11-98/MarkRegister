...
<body class="top-navbar-fixed">
            ...
            <div class="content-container">
                ...
                <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Manage Staffs Class</h2>
                            </div>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li> Staffs</li>
                                    <li class="active">Manage Staffs Class</li>
                                </ul>
                            </div>
                                            ...
                                            <div class="table-container">
                                                ...
                                                <table class="table" editable=true id="data-table">
                                                    <thead>
                                                        ...
                                                        <th colName="name">Staff Name</th>
                                                        <th colName="username">Classes</th>
    ...
    <script>
        getTableDataArray(<?php echo json_encode($existingData["staffclasses"]); ?>, true, <?php echo json_encode($existingData); ?>, "staffclasses", true, [false,false])
