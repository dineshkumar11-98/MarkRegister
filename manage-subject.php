...
<head>
    ...
    <title>Marke Register - Subjects</title>
...
<body class="top-navbar-fixed">
                                            ...
                                            <div class="table-container">
                                                ...
                                                <table class="table" editable=true id="data-table">
                                                    <thead>
                                                        ...
                                                        <th colName="class">Subject</th>
                                                        <th colName="section">Subject Code</th>
    ...
    <script>
        getTableDataArray(<?php echo json_encode($existingData["subjects"]); ?>, true, <?php echo json_encode($existingData); ?>, "subjects", true, [true, false])
